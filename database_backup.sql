...
COPY public.projects (id, title, total_hours) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.projects_id_seq', 151, true);
...
SELECT pg_catalog.setval('public.volunteers_id_seq', 101, true);
