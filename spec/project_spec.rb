...
describe Project do
  describe '#title' do
    it 'returns the project title' do
      project = Project.new({:title => 'Teaching Kids to Code', total_hours => 0, :id => nil})
  ...
  describe '#==' do
    it 'is the same project if two projects have the same title' do
      ...
      project2 = Project.new({:title => 'Teaching Kids to Code', total_hours => 0, :id => nil})
  ...
  context '.all' do
    ...
    it 'returns all projects' do
      project1 = Project.new({:title => 'Teaching Kids to Code', total_hours => 0, :id => nil})
      project1.save
      project2 = Project.new({:title => 'Teaching Ruby to Kids', total_hours => 0, :id => nil})
      project2.save
  ...
  describe '#volunteers' do
    it 'returns all volunteers for a specific project' do
      project = Project.new({:title => 'Teaching Kids to Code', total_hours => 0, :id => nil})
      project.save
      volunteer1 = Volunteer.new({:name => 'Jasmine', :project_id => project.id, total_hours => 0, :id => nil})
      volunteer1.save
      volunteer2 = Volunteer.new({:name => 'Joe', :project_id => project.id, total_hours => 0, :id => nil})
      volunteer2.save
  ...
  describe '#update' do
    it 'allows a user to update a project' do
      project = Project.new({:title => 'Teaching Kids to Code', total_hours => 0, :id => nil})
      project.save
      project.update({:title => 'Teaching Ruby to Kids', total_hours => 0, :id => nil})
